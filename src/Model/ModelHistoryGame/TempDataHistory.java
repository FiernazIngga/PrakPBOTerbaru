...
public class TempDataHistory {
    ...
    public void insertHistoryGame() {
        DataHistoryGame history = new DataHistoryGame();
        
        history.setNamaPilot1(
            getNamaPilot1()
        );

        history.setNamaPilot2(
            getNamaPilot2()
        );
        history.setNamaPesawat1(
            getNamaPesawat1()
        );
        history.setNamaPesawat2(
            getNamaPesawat2()
        );
        history.setWaktu_mulai(
            getWaktu_mulai()
        );
        history.setWaktu_selesai(
            getWaktu_selesai()
        );
        history.setWaktu_sekarang(
            getWaktu_sekarang()
        );
        history.setCatatan(
            getCatatan()
